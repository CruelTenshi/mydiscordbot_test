...
var bad_words = ["씨발", "개새끼", "tlqkf", "애미", "ㅅㅂ", "ㅄ", "ㅂㅅ", "등신", "병신", "미친", "느금", "ㄴㄱㅁ", "좆", "ㅈ같", 'ㅈ됬', 'ㅈ됐', 'ㅈ댓', 'ㅈ됨', 'ㅈ됏','ㅈ됫','시발','씹','ㄲㅈ','꺼져','새끼','ㄳㄲ','ㄱㅅㄲ', 'ㅅㄲ','창녀','걸레','남창','느개미','느개비','뒤져','닥쳐','ㄷㅊ','등신','똥꼬충','미치','ㅁㅊ','보전깨','피싸개','핏물싸개','뻐큐','fuck','sex','야스','tq','qt','rotorl','ac','쌍놈','쌍노무','쌍년','썅년','시팔',"씨팔",'염병','옘병','육변기','육시랄','존나','후장', '새기', 'ㅗㅗ', '씻발', '싯팔', '싯발', '씻팔', '보짓', '자짓', '앰창', '애비', '허벌', '조까', '7ㅐ', 'ㅅ발', 'ㅆ발','qudtls', '니앱', 'qt', , '야발', '챙녀', '꼬추','call.event.swearing()', '걸래', 'bitch', '년아', '놈아', '얼싸', '쉬벌', '년이', '놈이', 'ㅗ', '십팔', '씹빨', '십발', '씌발', '🖕', 'ㅣ발','ㅂㅏㄹ', 'ㅏㄹ', '시이바', '씨이바', '씨이빠', '세기', '세끼', '🤏', '🤌', '👉👌', '소추', '대추', '시이발', '씨이발', 'ㅈ같', '느그매', 'qkf', '쒸발', '느거매', '느거배', '씨빨', 'ㅗ', 'ㅆ바', 'ㅆ발', 'ㅅ바', 'ㅅ발', 'ㅂ신', '족같', '젖', '좃', '좉', '좇', '줫', '줱', '줟', '졷', '섹스', 'tprtm', '븅인', '빙신', '비웅신', '비융신', 'ㅈ됨', 'ㅈ댐', 'ㅈ됌', '시벌', '씨벌', '싸발', '야스', '야추', '야발', '시바', '씨바', '씨파'];
var edit_text = "";
